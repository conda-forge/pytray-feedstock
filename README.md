...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytray-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10506&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytray-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytray` can be installed with:

```
conda install pytray
```

It is possible to list all of the versions of `pytray` available on your platform with:
